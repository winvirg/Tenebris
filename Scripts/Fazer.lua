...
list[4].chance[1] = 87
list[4].gold[1] = 90000
list[4].explain[1] = "poder ofensivo: 3,208\nDefesa : 291"
...
list[4].explain[2] = "poder ofensivo: 4,765\nDefesa : 415"
...
list[4].explain[3] = "poder ofensivo: 8,189\nDefesa : 790"
...
list[4].explain[4] = "poder ofensivo: 9,899\nDefesa : 864"
...
list[4].explain[5] = "poder ofensivo: 22,684\nDefesa : 2,110"
...
list[4].explain[6] = "poder ofensivo: 46,081\nDefesa : 4,610"
...
list[5].explain[1] = "poder ofensivo: 4,112\nDefesa : 398"
...
list[5].explain[2] = "poder ofensivo: 5,388\nDefesa : 512"
...
list[5].explain[3] = "poder ofensivo: 6,412\nDefesa : 611"
...
list[5].explain[4] = "poder ofensivo: 10,934\nDefesa : 1,200"
...
list[5].explain[5] = "poder ofensivo: 27,534\nDefesa : 2,867"
...
list[5].explain[6] = "poder ofensivo: 58,123\nDefesa : 5,515"
...
list[6].chance[1] = 87
list[6].gold[1] = 80000
list[6].explain[1] = "poder ofensivo: 3,511\nDefesa : 332"
...
list[6].explain[2] = "poder ofensivo: 4,508\nDefesa : 436"
...
list[6].explain[3] = "poder ofensivo: 8,102\nDefesa : 781"
...
list[6].explain[4] = "poder ofensivo: 9,811\nDefesa : 911"
...
list[6].explain[5] = "poder ofensivo: 21,287\nDefesa : 1,853"
...
list[6].explain[6] = "poder ofensivo: 45,912\nDefesa : 4,051"
...
list[7].explain[1] = "poder ofensivo: 1,040"
...
list[7].explain[2] = "poder ofensivo: 3,476"
...
list[7].explain[3] = "poder ofensivo: 6,824"
...
list[7].explain[4] = "poder ofensivo: 9,909"
...
list[7].explain[5] = "poder ofensivo: 13,134"
...
list[7].explain[6] = "poder ofensivo: 16,773"
...
list[7].explain[7] = "poder ofensivo: 20,987"
...
list[7].explain[8] = "poder ofensivo: 29,120"
...
list[7].explain[9] = "poder ofensivo: 34,811"
...
list[7].explain[10] = "poder ofensivo: 44,458"
...
list[8].explain[1] = "poder ofensivo: 180"
...
list[8].explain[2] = "poder ofensivo: 378"
...
list[8].explain[3] = "poder ofensivo: 615"
...
list[8].explain[4] = "poder ofensivo: 854"
...
list[8].explain[5] = "poder ofensivo: 1,270"
...
list[8].explain[6] = "poder ofensivo: 1,677"
...
list[8].explain[7] = "poder ofensivo: 5,471"
...
list[8].explain[8] = "poder ofensivo: 6,979"
...
list[8].explain[9] = "poder ofensivo: 8,613"
...
list[8].explain[10] = "poder ofensivo: 9,458"
...
list[8].explain[11] = "poder ofensivo: 11,592"
...
list[8].explain[12] = "poder ofensivo: 14,006"
...
list[8].explain[13] = "poder ofensivo: 16,984"
...
list[8].explain[14] = "poder ofensivo: 19,280"
...
list[8].explain[15] = "poder ofensivo: 21,947"
...
list[8].explain[16] = "poder ofensivo: 23,879"
...
list[8].explain[17] = "poder ofensivo: 25,984"
...
list[8].explain[18] = "poder ofensivo: 28,001"
...
list[8].explain[19] = "poder ofensivo: 31,084"
...
list[8].explain[20] = "poder ofensivo: 33,947"
...
list[8].explain[21] = "poder ofensivo: 36,148"
...
list[8].explain[22] = "poder ofensivo: 39,431"
...
list[8].explain[23] = "poder ofensivo: 43,441"
...
function openItemCreate()
	...
	for i=1, 6 do
		guideListImage[i] = Image("Pictures/Transparência.png", Rect(328+((i-1)*32)+((i-1)*13), 64, 32, 32))
	...
	local function refresh(number)
		...
		for i=1, 6 do
			guideListImage[i].SetImage("Pictures/Transparência.png")
		...
		for i=1, #list[number].dataID do
			...
			button.onClick.Add(function()
				if sel ~= i then
					...
					for i2=1, 6 do
						guideListImage[i2].SetImage("Pictures/Transparência.png")
					...
					guideGoldText.text = "<color=#000000>Quantidade necessária : "..list[number].gold[i].." ouro</color>"
					guideChanceText.text = "<color=#000000>Probabilidade de sucesso : "..list[number].chance[i].."%</color>"
				else
